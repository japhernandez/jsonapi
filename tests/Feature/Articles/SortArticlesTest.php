...
class SortArticlesTest extends TestCase
{
    ...
    public function it_can_sort_articles_by_title_and_content()
    {
        ...
        /** \DB::listen(function ($db){dump($db->sql);});*/

        /**
         * Url a la que le envia la peticion
         * "http://localhost/api/v1/articles?sort=title,-content"
         * Consulta sql que devuelve el QueryBuilder
         * "select * from "articles" order by "title" asc, "content" desc"
         */
